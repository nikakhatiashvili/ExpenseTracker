...
class TribeIdImpl @Inject constructor(
    ...
    override suspend fun saveTribeId(){
        val ref = firebaseDatabase.getReference(resourceManager.provide(R.string.user)).child(firebaseAuth.currentUser?.uid!!)
        ref.child(resourceManager.provide(R.string.tribeId)).addListenerForSingleValueEvent(object : ValueEventListener {
